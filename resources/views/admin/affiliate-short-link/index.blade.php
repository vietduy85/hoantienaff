<x-app-layout>
    <div class="min-h-screen bg-gradient-to-b from-emerald-50 to-white">
        <div class="max-w-lg mx-auto max-[390px]:px-3 px-4 max-[390px]:py-3 py-4">
            ...
            >
                <div class="text-center max-[390px]:mb-2 mb-2.5">
                    <h2 class="font-semibold text-gray-900 text-lg" style="font-family: 'Inter', sans-serif">Tạo Short Link Affiliate</h2>
