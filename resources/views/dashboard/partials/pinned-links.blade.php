                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 max-[390px]:px-3 max-[390px]:py-2 px-4 py-2.5 flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-1 shrink-0">
                        ...
                        <form action="{{ route('link-requests.toggle-pin', $link) }}" method="POST">
                            @csrf
                            <button type="submit"
                                    class="text-xs px-2 h-8 flex items-center gap-1 rounded-lg bg-amber-50 hover:bg-amber-100 active:bg-amber-200 text-amber-500 transition-colors whitespace-nowrap"
                                    title="Bỏ ghim">
